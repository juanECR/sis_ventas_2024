    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/08/6a/98/086a98e69162a8d344ebe112c59d4b0a.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/89/d4/12/89d412c02f552f4240911d19c585a919.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/6d/2b/ab/6d2bab94cb9c264e0af13cda3457c6c9.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/70/af/d0/70afd0e297864199376cd1fa0a80992c.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/df/61/78/df61785b7ac9c5c4a7292a604fbe7ea6.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/4f/b8/b3/4fb8b372a9638d24640e8b6a3c8b25ad.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/80/60/5d/80605d4039c33364d13685a7b1e460dc.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
                <h6 class="card-subtitle mb-2 text-muted">HAWK</h6>
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/736x/e0/d8/a9/e0d8a94e8298800a226c42c0ebb65a71.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
                <h6 class="card-subtitle mb-2 text-muted">HAWK</h6>
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/87/74/06/877406ef6b4c9a8b4e19364acc631c6c.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
                <h6 class="card-subtitle mb-2 text-muted">HAWK</h6>
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/37/8a/4e/378a4e951efe696b47dd4d4db64f88b8.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
                <h6 class="card-subtitle mb-2 text-muted">HAWK</h6>
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/ea/28/a6/ea28a6b1a6ff6eb525afdcabd194a949.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
                <h6 class="card-subtitle mb-2 text-muted">HAWK</h6>
          ...
          <div class="col">
            <div class="card h-100">
              <div class="position-relative">
               <a href="detalleproducto.html"><img src="https://i.pinimg.com/564x/0c/4e/53/0c4e539d9b0f85ff6879a9d39cd25488.jpg" class="card-img-top" alt="Casaca Hombre Liam Rojo Carmin"></a> 
                <span class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1">-50%</span>
              </div>
              <div class="card-body">
                <h6 class="card-subtitle mb-2 text-muted">HAWK</h6>
